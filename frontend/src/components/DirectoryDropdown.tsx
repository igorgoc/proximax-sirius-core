...
const DEFAULT_DIR_PRESETS: DirectoryItem[] = isWin
  ? [
      { name: 'Linux Subsystem (Fast ext4): /var/lib/sirius/data', path: '/var/lib/sirius/data', isDir: true },
...
export const DirectoryDropdown: React.FC<DirectoryDropdownProps> = ({
  ...
  onChange,
  label,
  placeholder = isWin ? '/var/lib/sirius/data or C:\\Sirius_data' : './chainconfig/data',
  mode = 'dir',
  prompt,

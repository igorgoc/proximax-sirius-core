...
export const ConfigTab: React.FC<ConfigTabProps> = ({ config, harvestStats, metrics, onRefreshConfig }) => {
  ...
  const [formData, setFormData] = useState<NodeConfig>(() => ({
    ...
    dataPath: config?.dataPath || (typeof navigator !== 'undefined' && /win/i.test(navigator.userAgent || '') ? '/var/lib/sirius/data' : './chainconfig/data'),
          ...
          <section className="bg-[#181B20] border border-[#262B34] rounded-lg p-5 space-y-4">
            ...
            <div className="space-y-1.5">
              <DirectoryDropdown
                ...
                placeholder={typeof navigator !== 'undefined' && /win/i.test(navigator.userAgent || '') ? '/var/lib/sirius/data or C:\\Sirius_data' : '/Volumes/SSD/Sirius_data or ./chainconfig/data'}
